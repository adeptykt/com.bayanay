...
export default {
  ...
  // Segment
  segmentBackgroundColor: "#8B2120",
  segmentActiveBackgroundColor: "#fff",
  segmentTextColor: "#fff",
  segmentActiveTextColor: "#8B2120",
  segmentBorderColor: "#fff",
  segmentBorderColorMain: "#8B2120",
